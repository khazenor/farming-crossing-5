...
global.foodClassifications = {
  ...
  fcSavoryFoodsEatenCount: savoryFoods,
  fcLightFoodsEatenCount: lightFoods,
  fcHeavyFoodsEatenCount: heavyFoods,
  fcHotFoodsEatenCount: hotFoods,
  fcColdFoodsEatenCount: coldFoods,
  fcDryFoodsEatenCount: dryFoods,
  fcWetFoodsEatenCount: wetFoods
}